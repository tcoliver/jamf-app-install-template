...
APPLICATION_NAME="TextMate"
DOWNLOAD_URL="https://api.textmate.org/downloads/release?os=10.12"
CONTAINER_TYPE="tbz"
INSTALL_ACTION="move"
INSTALLER_NAME="TextMate.app"
INSTALLER_TYPE="app"
INSTALLED_PATH="/Applications/TextMate.app"
DETECTION_NAME=
SCRATCH_PREFIX=
RELAUNCH=
RELAUNCH_ARGS=()
